...
function readMemory() {
  ...
  for (const k of ['identity', 'feelings', 'facts', 'experiences', 'learnings', 'openThreads', 'toSelf', 'transcripts', 'agreements']) {
...
const BACKGROUNDABLE = ['identity', 'feelings', 'facts', 'experiences', 'learnings', 'openThreads', 'toSelf', 'agreements'];

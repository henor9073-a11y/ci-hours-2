...
export function addDaily({ date, headline, nor_status = '', cy_status = '', pending = '', intimate = '' }) {
  ...
  const metadata = { headline, nor_status, cy_status, pending, intimate };
  if (existing) {
...
function dailyOf(r) {
  ...
  return {
    ...
    nor_status: m.nor_status || '', cy_status: m.cy_status || '', pending: m.pending || '', intimate: m.intimate || '',

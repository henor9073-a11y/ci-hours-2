...
export function addDaily({ date, headline, body = '', nor_status = '', cy_status = '', pending = '', intimate = '', mood_tags, kiss_count }) {
  ...
  const metadata = { headline, body: String(body || ''), mood_tags: tags, nor_status, cy_status, pending, intimate, kiss_count: kisses };
  if (existing) {

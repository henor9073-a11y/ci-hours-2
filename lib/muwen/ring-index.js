...
import { file, readJSON, writeJSON, now, fallbackOpts, effortOpts } from './common.js';
...
export async function pickRings(message, { limit = 2, excludeIds = [], context = '' } = {}) {
  ...
  const res = await client.beta.messages.create({
    ...
    output_config: { ...effortOpts(RING_INDEX_MODEL, 'low'), format: { type: 'json_schema', schema: SCHEMA } },

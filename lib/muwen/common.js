...
// effort 同理：Haiku 4.5（以及更老的型号）传了会直接 400：
//   This model does not support the effort parameter
// 意图扩写换成 haiku 省钱之后，这一层就是这么哑掉的。只给明确支持的型号带上，
// 认不出来的新型号就不带——不带等于默认 high，不会报错。
export function effortOpts(model, level) {
  return /^claude-(opus-(4-[5-9]|5)|sonnet-(4-6|5)|fable-|mythos-)/.test(String(model || ''))
    ? { effort: level }
    : {};
}
